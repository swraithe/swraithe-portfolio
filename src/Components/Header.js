    ...
    <div className="bg-black">
      <header className="container mx-auto md:flex justify-between py-1 max-width">
        ...
        <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
          <ul className="dark:text-light-content text-white font-medium md:flex items-center md:space-x-5 md:mr-10">
          ...
          <ul className="flex justify-evenly text-xl items-center my-5 md:my-0 md:space-x-5 md:mr-5">
            {/* <li>
